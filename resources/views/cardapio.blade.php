                ...
                <div id="tab-1-up" class="tab-pane fade show p-0 active">
                    ...
                    <div class="tab-content">
                        ...
                        <input type="checkbox" id="salgmmeioameio{{ $produto->id }}" style="font-size: 12px;"> Meio a meio
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="openModal('{{ $produto->id }}')">
                                                    Comprar
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="salgmediaMeioModal{{ $produto->id }}" tabindex="-1" role="dialog" aria-labelledby="salgmediaMeioModalLabel{{ $produto->id }}" aria-hidden="true">
                                                                    ...
                                                                    <div class="col-md-4 col-sm-6 mb-3 d-flex align-items-stretch">
                                                                        <div class="card w-100">
                                                                            <div class="card-body d-flex flex-column text-center">
                                                                                ...
                                                                                <button class="btn btn-custom mt-auto" data-metade-id="{{ $salg->id }}" onclick="adicionarPizzaMetade({{ $salg->id }})">+</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                <div class="col-md-4 col-sm-6 mb-3 d-flex align-items-stretch">
                                                                    <div class="card w-100">
                                                                        <div class="card-body d-flex flex-column text-center">
                                                                            ...
                                                                            <button class="btn btn-custom mt-auto" data-metade-id="{{ $docem->id }}" onclick="adicionarPizzaMetade({{ $docem->id }})">+</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                        ...
                                        <script>
                                            ...
                                            function adicionarPizzaMetade(metadeId) {
...
{{--                                                            </div>--}}
{{--                                                            <input id="salggrandeMetadeId{{ $produto->id }}" name="metadeId" value="">--}}
{{--                                                            <input id="salggrandeAdicional1Id{{ $produto->id }}" name="adicional1Id" value="" >--}}
{{--                                                            <input id="salggrandeAdicional2Id{{ $produto->id }}" name="adicional2Id" value="" >--}}
{{--                                                            <button type="submit" class="btn btn-primary" style="margin-top: 10px;">Adicionar ao carrinho</button>--}}
{{--                                                        </form>--}}
{{--                                                    @endauth--}}
{{--                                                </div>--}}
...
{{--                                                                            <h6 class="card-title" style="font-size: 0.875rem;">{{ $docem->nome }}</h6>--}}
{{--                                                                            <p class="card-text" style="color: #000000;">R$ {{ number_format($docem->preco, 2, ',', '.') }}</p>--}}
{{--                                                                            <button class="btn btn-custom mt-auto" data-adicional-id="{{ $docem->id }}" data-action="add">+</button>--}}
{{--                                                                        </div>--}}
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
{{--                                                            @endforeach--}}
...
{{--                                                <div class="modal-footer">--}}
{{--                                                    <button type="button" onclick="location.reload()" class="btn btn-secondary" data-dismiss="modal">Fechar</button>--}}
{{--                                                    <button type="button" onclick="FinalizarProduto()" class="btn btn-primary">Finalizar produto</button>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}

{{--                                    <!-- Script específico para cada modal -->--}}
{{--                                    <script>--}}
{{--                                        // Função para abrir o modal de acordo com a seleção--}}
{{--                                        function openModal(produtoId) {--}}
{{--                                            pizzaIdSelecionada = produtoId; // Atualiza a variável com o ID do produto--}}
...
{{--                                                buttons.forEach(button => {--}}
{{--                                                    const isAddButton = button.getAttribute('data-action') === 'add';--}}

{{--                                                    // Desabilita todos os botões de adicionar se já tiver dois adicionais--}}
{{--                                                    if (campoOculto1.value && campoOculto2.value) {--}}
{{--                                                        if (isAddButton) {--}}
{{--                                                            button.disabled = true;--}}
{{--                                                        }--}}
...
{{--                                            const buttonsAdicionar = document.querySelectorAll('[data-action="add"]');--}}
{{--                                            buttonsAdicionar.forEach(button => {--}}
{{--                                                button.addEventListener('click', function () {--}}
{{--                                                    const adicionalId = this.getAttribute('data-adicional-id');--}}
{{--                                                    const modalId = this.closest('.modal').id.replace('salgmediaModal', '');--}}

{{--                                                    const campoOculto1 = document.getElementById(`salgmediaAdicional1Id${modalId}`);--}}
{{--                                                    const campoOculto2 = document.getElementById(`salgmediaAdicional2Id${modalId}`);--}}

{{--                                                    // Adiciona adicional na primeira textbox oculta se estiver vazia--}}
{{--                                                    if (!campoOculto1.value) {--}}
{{--                                                        campoOculto1.value = adicionalId;--}}
{{--                                                        this.setAttribute('data-action', 'remove'); // Muda para remover--}}
{{--                                                        this.innerText = 'Remover'; // Troca texto--}}
{{--                                                    } else if (!campoOculto2.value && campoOculto1.value !== adicionalId) {--}}
{{--                                                        // Adiciona na segunda se a primeira estiver ocupada e o adicional for diferente--}}
{{--                                                        campoOculto2.value = adicionalId;--}}
{{--                                                        this.setAttribute('data-action', 'remove'); // Muda para remover--}}
{{--                                                        this.innerText = 'Remover'; // Troca texto--}}
{{--                                                    }--}}

{{--                                                    updateButtonsState(modalId);--}}
{{--                                                });--}}
{{--                                            });--}}

{{--                                            // Adiciona evento de clique aos botões de remover--}}
{{--                                            const buttonsRemover = document.querySelectorAll('[data-action="remove"]');--}}
...
{{--                                                    this.setAttribute('data-action', 'add'); // Muda para adicionar--}}
{{--                                                    this.innerText = '+'; // Troca texto--}}
